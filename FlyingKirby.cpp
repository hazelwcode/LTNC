...
//Loads background images, music, and sound effects.
bool loadBackGround() {
    gJumpMusic = Mix_LoadWAV("flyingkirby/Resource/Sound/jump_sound.wav");
    gLoseMusic = Mix_LoadWAV("flyingkirby/Resource/Sound/lose_sound.wav");
    gBackgroundMusic = Mix_LoadMUS("flyingkirby/Resource/Sound/background_sound.wav");
...
//check collisions between kirby and enemy
...
void FlyingKirby::menuGame() {
    ...
    backgroundMenu.loadImage("flyingkirby/Resource/BackGround/menu.png", gRenderer);

    Button playButton;
    playButton.loadImage("flyingkirby/Resource/Button/play_button.png", gRenderer);
    playButton.setIdFrame(0);
    playButton.setPosX(PLAY_BUTTON_POSX);
    playButton.setPosY(PLAY_BUTTON_POSY);

    Button helpButton;
    helpButton.loadImage("flyingkirby/Resource/Button/help_button.png", gRenderer);
    helpButton.setIdFrame(0);
    helpButton.setPosX(HELP_BUTTON_POSX);
    helpButton.setPosY(HELP_BUTTON_POSY);

    Button exitButton;
    exitButton.loadImage("flyingkirby/Resource/Button/exit_button.png", gRenderer);
...
void FlyingKirby::displayGame() {
    ...
    pauseButton.loadImage("flyingkirby/Resource/Button/pause_button.png", gRenderer);
    ...
    pauseButtonRemove.loadImage("flyingkirby/Resource/Button/pause_button_remove.png", gRenderer);
    ...
    soundOnButtonRemove.loadImage("flyingkirby/Resource/Button/soundOn_button_remove.png", gRenderer);
    ...
    soundOnButton.loadImage("flyingkirby/Resource/Button/soundOn_button.png", gRenderer);
    ...
    soundOffButton.loadImage("flyingkirby/Resource/Button/soundOff_button.png", gRenderer);
    ...
    while (!quit) {
        ...
        ifstream file("flyingkirby/Resource/Database/HighScore.txt");
        int highScore;
        file >> highScore;
        file.close();
        ...
        while (isRunning) {
            ...
            if (score >= highScore) {
                ofstream file("flyingkirby/Resource/Database/HighScore.txt");
                file << highScore;
                file.close();
            }
            ...
            if (checkColi(kirby, Air) || checkColi(kirby, Ground1) || checkColi(kirby, Ground2)) {
                ...
                SDL_Surface* loadSurface = IMG_Load("flyingkirby/Resource/BackGround/lose.png");
            ...
            double realTime = timer.getTicks();
            double timeOneFrame = 1000 / FRAME_PER_SECOND;
            if (realTime < timeOneFrame) {
                int delayTime = timeOneFrame - realTime;
                SDL_Delay(delayTime);
            }
...
void FlyingKirby::displayHelpGame() {
    ...
    backButton.loadImage("flyingkirby/Resource/Button/back_button.png", gRenderer);
